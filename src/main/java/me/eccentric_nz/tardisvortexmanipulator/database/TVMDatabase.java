...
public class TVMDatabase {
    ...
    public void setConnection() {
        ...
        String jdbc = "jdbc:mysql://" + TARDISVortexManipulator.plugin.getConfig().getString("storage.mysql.host") + ":" + TARDISVortexManipulator.plugin.getConfig().getString("storage.mysql.port") + "/" + TARDISVortexManipulator.plugin.getConfig().getString("storage.mysql.database") + "?autoReconnect=true";
